...
import { CollapsibleTrigger, CollapsibleContent, Collapsible } from "@radix-ui/react-collapsible";
import {
  Home, FileText, ChevronDown, Settings, LayoutDashboard,
  Split, Banknote,
} from "lucide-react";
    ...
    <Sidebar className="relative border-none">
      ...
      <SidebarHeader className="bg-primary text-white border-b">
        <div className="flex items-center gap-3 px-3">
          <img src="/assets/logo.svg" alt="sunway" width={38} className="my-2" />
          <div className="flex flex-col items-start">
            <h1 className="font-display font-bold text-xl text-white">Sunway</h1>
      ...
      <SidebarContent className="px-4 bg-background pt-3">
        ...
        <SidebarMenu>
          <SidebarMenuItem>
            <SidebarMenuButton asChild>
              <Link to="/" className={cn("flex gap-2 items-center", path === "/" && "bg-primary text-secondary")}>
        ...
        {/* Normal sections */}
        {!adminView && sidebarItems.map((section) => (
