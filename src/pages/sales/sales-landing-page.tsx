...
import { ShoppingBag, ShoppingCart, FileText, Package, Truck, Users, Receipt, Search, TrendingUp, Clock, CheckCircle, DollarSign, X } from "lucide-react";
...
export default function SalesLandingPage() {
  ...
  const handleSearch = (query: string) => {
    ...
    if (foundOrder) {
      ...
      alert(`No results found for "${query}". Try searching for order numbers, customer names, or invoice numbers.`);
    }
  };
  ...
  return (
    <div className="p-4 sm:p-6 space-y-6 sm:space-y-8 min-w-0">
      ...
      <div className="mb-6 sm:mb-8">
        <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold mb-2 sm:mb-3 text-foreground break-words">Sales</h1>
        <p className="text-base sm:text-lg text-muted-foreground break-words">Manage sales orders, customers, and invoices</p>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-6 sm:mb-8 items-stretch">
          ...
          <CardContent className="p-3 sm:p-4 lg:p-6">
            <div className="flex items-center justify-between gap-2 min-w-0">
              <div className="min-w-0 flex-1 overflow-hidden">
                <p className="text-xs sm:text-sm font-medium text-muted-foreground truncate">Total Sales</p>
                <p className="text-lg sm:text-xl lg:text-2xl font-bold mt-0.5 sm:mt-1 break-all">₹{totalSales.toLocaleString()}</p>
              </div>
        ...
        <Card className="hover:shadow-md transition-shadow min-w-0 overflow-hidden">
          <CardContent className="p-3 sm:p-4 lg:p-6">
            <div className="flex items-center justify-between gap-2 min-w-0">
              <div className="min-w-0 flex-1 overflow-hidden">
                <p className="text-xs sm:text-sm font-medium text-muted-foreground truncate">Dispatches Today</p>
                <p className="text-lg sm:text-xl lg:text-2xl font-bold mt-0.5 sm:mt-1 break-all">{dispatchesToday}</p>
              </div>
      ...
      <div className="space-y-4 sm:space-y-6">
        <div>
          <h2 className="text-xl sm:text-2xl font-semibold mb-3 sm:mb-4 text-foreground break-words">Sales Operations</h2>
            ...
            <Card className="hover:shadow-lg transition-shadow border-2 hover:border-blue-300 min-w-0 flex flex-col h-full justify-between">
              <CardHeader className="flex-shrink-0 px-4 sm:px-5 lg:px-6 pt-4 sm:pt-5 lg:pt-6 pb-3 sm:pb-4">
                <div className="flex items-start gap-3 min-w-0">
                  ...
                  <div className="flex-1 min-w-0 overflow-hidden">
                    <CardTitle className="text-base sm:text-base lg:text-lg break-words leading-tight font-semibold">Manage Sales Orders</CardTitle>
                    <CardDescription className="text-xs sm:text-sm break-words mt-1.5">View and manage sales orders</CardDescription>
                  </div>
                </div>
              </CardHeader>
              <CardContent className="flex-shrink-0 px-4 sm:px-5 lg:px-6 pb-4 sm:pb-5 lg:pb-6 pt-0">
                <Button asChild className="w-full bg-blue-600 hover:bg-blue-700 text-sm sm:text-sm lg:text-base">
                  <Link to="/inventory/sales/orders" className="block text-center">Manage Sales Orders</Link>
                </Button>
              </CardContent>
            </Card>
            ...
            <Card className="hover:shadow-lg transition-shadow border-2 hover:border-green-300 min-w-0 flex flex-col h-full justify-between">
              <CardHeader className="flex-shrink-0 px-4 sm:px-5 lg:px-6 pt-4 sm:pt-5 lg:pt-6 pb-3 sm:pb-4">
                <div className="flex items-start gap-3 min-w-0">
                  ...
                  <div className="flex-1 min-w-0 overflow-hidden">
                    <CardTitle className="text-base sm:text-base lg:text-lg break-words leading-tight font-semibold">Create New Sales</CardTitle>
                    <CardDescription className="text-xs sm:text-sm break-words mt-1.5">Create a new sales order</CardDescription>
                  </div>
                </div>
              </CardHeader>
              <CardContent className="flex-shrink-0 px-4 sm:px-5 lg:px-6 pb-4 sm:pb-5 lg:pb-6 pt-0">
                <Button asChild className="w-full bg-green-600 hover:bg-green-700 text-sm sm:text-sm lg:text-base">
                  <Link to="/inventory/sales/orders/new" className="block text-center">Create New Sales Order</Link>
                </Button>
              </CardContent>
            </Card>
            ...
            <Card className="hover:shadow-lg transition-shadow border-2 hover:border-blue-300 min-w-0 flex flex-col h-full justify-between">
              <CardHeader className="flex-shrink-0 px-4 sm:px-5 lg:px-6 pt-4 sm:pt-5 lg:pt-6 pb-3 sm:pb-4">
                <div className="flex items-start gap-3 min-w-0">
                  ...
                  <div className="flex-1 min-w-0 overflow-hidden">
                    <CardTitle className="text-base sm:text-base lg:text-lg break-words leading-tight font-semibold">Sales Invoices</CardTitle>
                    <CardDescription className="text-xs sm:text-sm break-words mt-1.5">Manage invoices and payments</CardDescription>
                  </div>
                </div>
              </CardHeader>
              <CardContent className="flex-shrink-0 px-4 sm:px-5 lg:px-6 pb-4 sm:pb-5 lg:pb-6 pt-0">
                <Button asChild className="w-full bg-blue-600 hover:bg-blue-700 text-sm sm:text-sm lg:text-base">
                  <Link to="/inventory/sales/invoices" className="block text-center">View Invoices</Link>
                </Button>
              </CardContent>
            </Card>
          </div>
        ...
        <div className="space-y-4 sm:space-y-6">
          <h2 className="text-xl sm:text-2xl font-semibold mb-3 sm:mb-4 text-foreground break-words">Customer & Dispatch</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 lg:gap-6 min-w-0 items-stretch">
            {/* Customers */}
            <Card className="hover:shadow-lg transition-shadow border-2 hover:border-amber-300 min-w-0 flex flex-col h-full justify-between">
              <CardHeader className="flex-shrink-0 px-4 sm:px-5 lg:px-6 pt-4 sm:pt-5 lg:pt-6 pb-3 sm:pb-4">
                <div className="flex items-start gap-3 min-w-0">
                  ...
                  <div className="flex-1 min-w-0 overflow-hidden">
                    <CardTitle className="text-base sm:text-base lg:text-lg break-words leading-tight font-semibold">Customer Management</CardTitle>
                    <CardDescription className="text-xs sm:text-sm break-words mt-1.5">Manage customer information</CardDescription>
                  </div>
                </div>
              </CardHeader>
              <CardContent className="flex-shrink-0 px-4 sm:px-5 lg:px-6 pb-4 sm:pb-5 lg:pb-6 pt-0">
                <Button asChild className="w-full bg-amber-600 hover:bg-amber-700 text-sm sm:text-sm lg:text-base">
                  <Link to="/inventory/sales/customers" className="block text-center">Manage Customers</Link>
                </Button>
              </CardContent>
            </Card>
            ...
            <Card className="hover:shadow-lg transition-shadow border-2 hover:border-amber-300 min-w-0 flex flex-col h-full justify-between">
              <CardHeader className="flex-shrink-0 px-4 sm:px-5 lg:px-6 pt-4 sm:pt-5 lg:pt-6 pb-3 sm:pb-4">
                <div className="flex items-start gap-3 min-w-0">
                  ...
                  <div className="flex-1 min-w-0 overflow-hidden">
                    <CardTitle className="text-base sm:text-base lg:text-lg break-words leading-tight font-semibold">Picklist & Dispatch</CardTitle>
                    <CardDescription className="text-xs sm:text-sm break-words mt-1.5">Generate picklists and plan dispatch</CardDescription>
                  </div>
                </div>
              </CardHeader>
              <CardContent className="flex-shrink-0 px-4 sm:px-5 lg:px-6 pb-4 sm:pb-5 lg:pb-6 pt-0">
                <Button asChild className="w-full bg-amber-600 hover:bg-amber-700 text-sm sm:text-sm lg:text-base">
                  <Link to="/inventory/sales/picklist" className="block text-center">Picklist & Dispatch</Link>
                </Button>
              </CardContent>
            </Card>
            ...
            <Card className="hover:shadow-lg transition-shadow border-2 hover:border-orange-300 min-w-0 flex flex-col h-full justify-between">
              <CardHeader className="flex-shrink-0 px-4 sm:px-5 lg:px-6 pt-4 sm:pt-5 lg:pt-6 pb-3 sm:pb-4">
                <div className="flex items-start gap-3 min-w-0">
                  ...
                  <div className="flex-1 min-w-0 overflow-hidden">
                    <CardTitle className="text-base sm:text-base lg:text-lg break-words leading-tight font-semibold">Delivery Tracking</CardTitle>
                    <CardDescription className="text-xs sm:text-sm break-words mt-1.5">Track shipments and deliveries</CardDescription>
                  </div>
                </div>
              </CardHeader>
              <CardContent className="flex-shrink-0 px-4 sm:px-5 lg:px-6 pb-4 sm:pb-5 lg:pb-6 pt-0">
                <Button asChild className="w-full bg-orange-600 hover:bg-orange-700 text-sm sm:text-sm lg:text-base">
                  <Link to="/inventory/sales/tracking" className="block text-center">Track Deliveries</Link>
                </Button>
              </CardContent>
            </Card>
          </div>
