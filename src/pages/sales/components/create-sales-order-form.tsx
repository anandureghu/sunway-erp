...
export function CreateSalesOrderForm({ onCancel }: Props) {
  ...
  >({
    ...
    defaultValues: { orderDate: format(new Date(), "yyyy-MM-dd"), items: [] },
    mode: "onChange",
  });
  ...
  const onSubmit = async (data: any) => {
    ...
    if (!validationResult.success) return toast.error("Please correct form errors.");
  ...
  if (loading) {
    return <div className="p-10 text-center text-muted-foreground">Loading order form...</div>;
  }
        ...
        <CardContent className="p-6">
          <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-xs uppercase tracking-wide text-white/70">Sales</p>
            ...
            <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                {formState.errors.customerId && (
                  <p className="text-sm text-red-500">{formState.errors.customerId.message}</p>
                )}
              </div>
              <div className="space-y-2">
              ...
              <div className="space-y-2 md:col-span-2">
                ...
                <Textarea placeholder="Enter shipping address" {...register("shippingAddress")} />
              </div>
            </CardContent>
          </Card>
