...
function Modal({
  ...
  return (
    ...
    >
      <div
        className={`bg-white rounded-2xl w-full ${sizeClasses[size]} shadow-2xl overflow-hidden m-4 animate-in zoom-in-95 duration-200`}
      >
        ...
        >
          <div className="space-y-5">
            ...
            <p className="text-xs text-slate-400">
              💡 Note: Permissions for each module can be configured in{" "}
              <span className="text-blue-600 font-medium">
                HR Settings → Permissions
              </span>
              .
            </p>
