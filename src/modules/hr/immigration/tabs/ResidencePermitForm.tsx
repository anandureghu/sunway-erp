  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      try {
        ...
        console.error(
          "ResidencePermitForm -> failed to load:",
    ...
    switch (validity.status) {
      ...
      case "pending":
        return {
          ...
          badgeBg: "bg-blue-500",
          description:
            "Your residence permit status is pending and awaiting official confirmation.",
        };
      default:
        return null;
    }
  ...
  return (
    <div className="space-y-6">
      ...
      <SecondaryPageHeader
        ...
        description="Manage immigration documentation and residence status"
