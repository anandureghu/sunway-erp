                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-slate-600">
                          {[
                            ...
                            .filter(Boolean)
                            .join(" - ") || "Complete education information"}
...
function InfoCard({
  ...
  return (
    <div
      className={`bg-gradient-to-br ${colorClasses[color as keyof typeof colorClasses]} rounded-xl p-5 text-white shadow-lg`}
    >
      <div className="flex items-center gap-3 mb-2">
